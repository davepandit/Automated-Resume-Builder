...
function Skills({ resumeInfo, enanbledNext }) {
  ...
  const getInputBorderClass = (fieldError) => 
      fieldError ? "border-red-500 focus:border-red-600" : "border-gray-300 focus:border-indigo-500";
  ...
  return (
    ...
    <div className="p-6 shadow-xl rounded-xl border-t-indigo-600 border-t-4 bg-white dark:bg-gray-800 mt-10 space-y-6">
      ...
      <div className="space-y-1">
        <h2 className="font-extrabold text-2xl text-gray-800 dark:text-gray-100">Skills</h2>
        <p className="text-gray-600 dark:text-gray-400">Add your top professional key skills and rate your proficiency.</p>
      </div>
        ...
        {skillsList.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-start sm:items-center w-full sm:w-auto mt-2 sm:mt-0">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 sm:hidden">Proficiency</label>
                <Rating
