...
const AlertDialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // STYLISH: Ensure the overlay fades in nicely
...
const AlertDialogContent = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // STYLISH: Larger border-radius (rounded-xl), pronounced shadow
...
const AlertDialogHeader = ({ className, ...props }) => (
  <div
    // STYLISH: Added a bottom margin for spacing
    className={cn(
...
const AlertDialogFooter = ({ className, ...props }) => (
  <div
    // STYLISH: Improved spacing between buttons
    className={cn(
...
const AlertDialogTitle = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    // STYLISH: Slightly bolder title and darker text
    className={cn(
...
const AlertDialogDescription = React.forwardRef(
  ({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Description
      ref={ref}
      // STYLISH: Adjusted text color for better readability in both light/dark mode
...
const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    // STYLISH: Use 'ghost' variant for cancel button and better vertical spacing
    className={cn(
